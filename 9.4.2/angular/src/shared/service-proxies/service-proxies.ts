...
export class GMSTransactionServiceProxy {
     ...
     * @return OK
     */
    getGMSTransaction(groupMemberRefNO: string | undefined, transactionDate: moment.Moment | undefined, paymentStructureId: number | undefined, groupId: number | undefined): Observable<GMSTransactionResponseDTOListAPIResponse> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<GMSTransactionResponseDTOListAPIResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GMSTransactionResponseDTOListAPIResponse>;
        }));
    }

    protected processGetGMSTransaction(response: HttpResponseBase): Observable<GMSTransactionResponseDTOListAPIResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GMSTransactionResponseDTOListAPIResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class GroupParticipantServiceProxy {
     ...
     * @return OK
     */
    updateParticipants(body: GroupParticipantsUpdateDTO | undefined): Observable<GroupParticipantResponseDTOAPIResponse> {
    ...
    protected processUpdateParticipants(response: HttpResponseBase): Observable<GroupParticipantResponseDTOAPIResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    deleteParticipants(membId: number | undefined): Observable<BooleanAPIResponse> {
    ...
    protected processDeleteParticipants(response: HttpResponseBase): Observable<BooleanAPIResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class GMSTransactionResponseDTO implements IGMSTransactionResponseDTO {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.paymentStructureName = _data["paymentStructureName"];
    ...
    toJSON(data?: any) {
        ...
        data["paymentStructureName"] = this.paymentStructureName;
...
export class GMSTransactionResponseDTOListAPIResponse implements IGMSTransactionResponseDTOListAPIResponse {
    result: GMSTransactionResponseDTO[] | undefined;
    message: string | undefined;

    constructor(data?: IGMSTransactionResponseDTOListAPIResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["result"])) {
                ...
                for (let item of _data["result"])
                    this.result.push(GMSTransactionResponseDTO.fromJS(item));
            }
            this.message = _data["message"];
        }
    }

    static fromJS(data: any): GMSTransactionResponseDTOListAPIResponse {
        data = typeof data === 'object' ? data : {};
        let result = new GMSTransactionResponseDTOListAPIResponse();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.result)) {
            ...
            for (let item of this.result)
                data["result"].push(item ? item.toJSON() : <any>undefined);
        }
        data["message"] = this.message;
        return data;
    }

    clone(): GMSTransactionResponseDTOListAPIResponse {
        const json = this.toJSON();
        let result = new GMSTransactionResponseDTOListAPIResponse();
        result.init(json);
        return result;
...
export interface IGMSTransactionResponseDTOListAPIResponse {
    result: GMSTransactionResponseDTO[] | undefined;
    message: string | undefined;
}
