        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChairmanMobileNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GroupRegion = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GroupDistrict = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GroupWard = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GroupMemberRefNO = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupParticipants_GroupDetails_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentStructures_GroupDetails_GroupId",
                        column: x => x.GroupId,
                        principalTable: "GroupDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GMSTransactions_PaymentStructures_PaymentStructureId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_PaymentStructures_PaymentStructureId",
                        column: x => x.PaymentStructureId,
                        principalTable: "PaymentStructures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentStructures_GroupId",
                table: "PaymentStructures",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_PaymentStructureId",
                table: "Transactions",
                column: "PaymentStructureId");
        }
