...
namespace GroupManagementSystem.Migrations
{
    ...
    [Migration("20250805052852_ChangingStatusPropertyToEnumIngmsTrasniction")]
    partial class ChangingStatusPropertyToEnumIngmsTrasniction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("GroupManagementSystem.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("GroupManagementSystem.Authorization.Users.User", null)
                        .WithMany("Claims")
